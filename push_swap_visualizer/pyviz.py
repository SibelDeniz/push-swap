...
class PsGui:
    def __init__(self, master):
        ...
        self.pile_b = []
        self.cmds = subprocess.check_output(
            [PUSHS_PATH] + sys.argv[1:], stderr=subprocess.STDOUT, timeout=12
        ).splitlines()
